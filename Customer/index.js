...
app.post('/checkout', async (req, res) => {
  profile_user = await PersonModel.findOne({"emailid": req.body.emailid})
  product_info = await ProductModel.findOne({"product_name": req.body.product_name})
  ...
  if (profile_user != null && product_info != null) {
    pobj.save()
    .then(insertdocuemnt => {
